...
message("")
message("=================================" )
message("  ENTERING FindOpenACC.cmake")
message("=================================" )
message("")
...
function(_OPENACC_GET_FLAGS LANG FLAG_VAR)
  ...
  message("FLAG_CANDIDATES = ${FLAG_CANDIDATES}")
  
  foreach(FLAG IN LISTS FLAG_CANDIDATES)
    message("try_compile with ${FLAG}")
	...
	message("OpenACC_TRY_COMPILE_OUTPUT = ${OpenACC_TRY_COMPILE_OUTPUT}")

...
!$ACC PARALLEL PRIVATE(KMLOC,JN,JFLD) PRESENT(YDSP, PIA) CREATE(ZTEMP) DEFAULT(NONE) VECTOR_LENGTH(32) FIRSTPRIVATE(IFIELDS,R_NSMAX,D_NUMP) PRIVATE(ZTEMP,JNSEC,JFLDSEC,JNSECEND,JFLDSECEND)

...
!$ACC PARALLEL PRIVATE(KMLOC,JN,JFLD) PRESENT(YDSP, PIA) CREATE(ZTEMP1,ZTEMP2) DEFAULT(NONE) VECTOR_LENGTH(32) FIRSTPRIVATE(IFIELDS) PRIVATE(ZTEMP1,ZTEMP2,JNSEC,JFLDSEC,JNSECEND,JFLDSECEND)
!$ACC CACHE(ZTEMP1(ISIZE+1,ISIZE),ZTEMP2(ISIZE+1,ISIZE))

...
!$ACC PARALLEL PRIVATE(KMLOC,JN,JFLD) PRESENT(YDSP, PIA) CREATE(ZTEMP1,ZTEMP2) DEFAULT(NONE) VECTOR_LENGTH(32) FIRSTPRIVATE(IFIELDS) PRIVATE(ZTEMP,JNSEC,JFLDSEC,JNSECEND,JFLDSECEND)

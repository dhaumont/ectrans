...
#define TRGTOL_DTYPE MPI_REAL8
    ...
    DO INS=1,ISEND_COUNTS
      ...
      !$OMP& ISEND_WSET_OFFSET_V,INS,ICOMBUFS_OFFSET_V,IFLDA,ZCOMBUFS,YDGP) &
    ...
    IF(LLOCAL_CONTRIBUTION)THEN
      ...
      !$OMP& IRECV_BUFR_TO_OUT_V,IRECV_BUFR_TO_OUT,PREEL_REAL,YDGP) MAP(TO:KF_FS,IRECV_BUFR_TO_OUT_V)
#endif

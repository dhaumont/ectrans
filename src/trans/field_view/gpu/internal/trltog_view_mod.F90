...
#define TRLTOG_DTYPE MPI_REAL8
    ...
    IF(LLOCAL_CONTRIBUTION) THEN
      ...
      DO JFLD=1,KF_FS    
         ...
         !$ACC PARALLEL LOOP PRIVATE(JK,JBLK,IPOS) USE_DEVICE(ZZ) FIRSTPRIVATE(KF_FS,IRECV_WSET_SIZE_V,IRECV_WSET_OFFSET_V, &
    ...
    DO INR=1,IRECV_COUNTS
      ...
      !$ACC PARALLEL LOOP PRIVATE(JK,JBLK,JI) FIRSTPRIVATE(IRECV_FIELD_COUNT_V,INR,IRECV_WSET_SIZE_V,&

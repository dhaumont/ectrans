...
#endif
#ifdef ACCGPU
      !$ACC PARALLEL LOOP INDEPENDENT DEFAULT(NONE) PRIVATE(IFLD,ZZ) FIRSTPRIVATE(KF_FS,IRECV_WSET_SIZE_V,IRECV_WSET_OFFSET_V, &
...
#endif
#ifdef ACCGPU
      !$ACC PARALLEL LOOP INDEPENDENT DEFAULT(NONE) PRIVATE(JI,ZZ) &

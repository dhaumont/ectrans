...
ICOUNT = 0
YLSPU = WRAP(YLGVU,ZGTF,ICOUNT)
YLSPV = WRAP(YLGVV,ZGTF,ICOUNT)
YLSPVSCALAR = WRAP(YLGVSCALAR,ZGTF,ICOUNT)
YLSPU_EW = WRAP(YLGVU_EW,ZGTF,ICOUNT)
YLSPV_EW = WRAP(YLGVV_EW,ZGTF,ICOUNT)
YLSPVSCALAR_NS = WRAP(YLGVSCALAR_NS,ZGTF,ICOUNT)
YLSPVSCALAR_EW = WRAP(YLGVSCALAR_EW,ZGTF,ICOUNT)
...
FUNCTION WRAP(YGP,PZGTF,KI) RESULT(YSP)

...
YLGV = [YLGVU,YLGVV,YLGVSCALAR,YLGVVOR,YLGVDIV,YLGVU_EW,YLGVV_EW,YLGVSCALAR_NS,YLGVSCALAR_EW]
CALL APPEND_IVSET(YLGV,IVSET)
...
SUBROUTINE APPEND_IVSET(YGP,KVSET)
  TYPE(GRID_VIEW), INTENT(IN) :: YGP(:)
  INTEGER(KIND=JPIM), INTENT(INOUT) :: KVSET(:)

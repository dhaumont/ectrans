...
SUBROUTINE TRLTOG_VIEW(PGLAT, KF_FS, KF_GP, KVSET, YLGVU,YLGVV,YLGVSCALAR,KPTRGP)
...
CALL TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KVSET, KPTRGP, YLGVU,YLGVV,YLGVSCALAR, &
  &              YDBUFS)
...
SUBROUTINE TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KVSET, KPTRGP, YLGVU,YLGVV,YLGVSCALAR,YDBUFS)

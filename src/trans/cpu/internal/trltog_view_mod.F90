...
SUBROUTINE TRLTOG_VIEW(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, YLGVU,YLGVV,YLGVSCALAR,KPTRGP)
...
CALL TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, IVSET, KPTRGP, YLGVU,YLGVV,YLGVSCALAR, &
  &              YDBUFS)
...
SUBROUTINE TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, IVSET, KPTRGP, YLGVU,YLGVV,YLGVSCALAR,YDBUFS)

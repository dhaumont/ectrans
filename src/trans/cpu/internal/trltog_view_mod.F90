...
SUBROUTINE TRLTOG_VIEW(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, KVSET, KPTRGP, YLGVU,YLGVV,YLGVSCALAR)
...
USE ECTRANS_FIELD_VIEW_MOD, ONLY : GRID_VIEW
...
TYPE(GRID_VIEW), INTENT(OUT), ALLOCATABLE :: YLGVU(:),YLGVV(:)
TYPE(GRID_VIEW), INTENT(OUT), ALLOCATABLE :: YLGVSCALAR(:)
...
CALL TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, KVSET, KPTRGP, YLGVU,YLGVV,YLGVSCALAR, &
  &              YDBUFS)
...
SUBROUTINE TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, KVSET, KPTRGP, YLGVU,YLGVV,YLGVSCALAR,YDBUFS)

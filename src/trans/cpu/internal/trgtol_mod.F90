...
INTEGER(KIND=JPIM) :: IPOSPLUS(YDBUFS%INSEND)
INTEGER(KIND=JPIM) :: ISETW(YDBUFS%INSEND)
INTEGER(KIND=JPIM) :: IJPOS(NGPBLKS,YDBUFS%INSEND)
INTEGER(KIND=JPIM) :: IFLDA(KF_GP,YDBUFS%INSEND)
...
CALL TRGL_BIND_BUFFERS_SR(YDBUFS, KF_GP, KNSEND, IPOSPLUS,ISETW,IJPOS,IFLDA)

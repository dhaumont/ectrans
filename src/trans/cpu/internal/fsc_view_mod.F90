...
TYPE(SPEC_VIEW), INTENT(IN) :: YLSPVUV(:),YLSPVSCALAR(:)
TYPE(SPEC_VIEW), INTENT(IN) :: YLSPVUV_EW(:),YLSPVSCALAR_NS(:), YLSPVSCALAR_EW(:)
...
KF_UV = SIZE(YLSPVUV)/2
KF_SCALARS = SIZE(YLSPVSCALAR)
KF_SCDERS = SIZE(YLSPVSCALAR_NS)

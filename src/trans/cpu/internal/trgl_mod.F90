...
TYPE TRGL_BUFFERS
  ...
  INTEGER(KIND=JPIM), POINTER :: ISENDTOT (:)
  INTEGER(KIND=JPIM), POINTER :: IRECVTOT (:)
  INTEGER(KIND=JPIM), POINTER :: ISEND(:)
  INTEGER(KIND=JPIM), POINTER :: IRECV(:)
  INTEGER(KIND=JPIM), POINTER :: IINDEX(:)
  INTEGER(KIND=JPIM), POINTER :: INDOFF(:)
  INTEGER(KIND=JPIM), POINTER :: IGPTRSEND(:,:,:)
  INTEGER(KIND=JPIM), POINTER :: ISETWL(:)
  INTEGER(KIND=JPIM), POINTER :: ISETVL(:)
  INTEGER(KIND=JPIM), POINTER :: ISETW(:)
  INTEGER(KIND=JPIM), POINTER :: IJPOS(:,:)
  INTEGER(KIND=JPIM), POINTER :: IPOSPLUS(:)
  INTEGER(KIND=JPIM), POINTER :: IFLDA(:,:)
END TYPE TRGL_BUFFERS

TYPE TRGL_VARS
  INTEGER(KIND=JPIM), POINTER :: IUVLEVS(:)
  INTEGER(KIND=JPIM), POINTER :: IUVPARS(:)
  INTEGER(KIND=JPIM), POINTER :: IGP2PARS(:)
  INTEGER(KIND=JPIM), POINTER :: IFLDOFF(:)
  INTEGER(KIND=JPIM), POINTER :: IGPTROFF(:)
  INTEGER(KIND=JPIM), POINTER :: IGP3APARS(:)
  INTEGER(KIND=JPIM), POINTER :: IGP3ALEVS(:)
  INTEGER(KIND=JPIM), POINTER :: IGP3BPARS(:)
  INTEGER(KIND=JPIM), POINTER :: IGP3BLEVS(:)

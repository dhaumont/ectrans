...
IF(PRESENT(KVSETSC2)) THEN
   WRITE(20,*) "KVSETSC2", SIZE(KVSETSC2)
  WRITE(20,*) KVSETSC2
...
IF(PRESENT(KVSETSC3A)) THEN
   WRITE(20,*) "KVSETSC3A", SIZE(KVSETSC3A)
  WRITE(20,*) KVSETSC3A
...
IF(PRESENT(KVSETSC3B)) THEN
   WRITE(20,*) "KVSETSC3B", SIZE(KVSETSC3B)
  WRITE(20,*) KVSETSC3B
...
WRITE(20,'(A11,I4,A2)') "NPROMA   | ", NPROMA,  ' |'
WRITE(20,'(A11,I4,A2)') "NBLKS    | ", NGPBLKS, ' |'
WRITE(20,'(A11,L4,A2)') "LDUVDER  | ", LUVDER,  ' |'
WRITE(20,'(A11,L4,A2)') "LVORGP  | ", LVORGP,  ' |'
WRITE(20,'(A11,L4,A2)') "LDIVGP  | ", LDIVGP,  ' |'
WRITE(20,'(A11,L4,A2)') "LDSCDERS | ", LDSCDERS,  ' |'

WRITE(20,*) "IF_UV", IF_UV
WRITE(20,*) "IF_UV_G", IF_UV_G
WRITE(20,*) "IF_UV_PAR",  IF_UV_PAR
WRITE(20,*) "IF_SCALARS", IF_SCALARS
WRITE(20,*) "IF_SCALARS_G", IF_SCALARS_G
WRITE(20,*) "IF_SCDERS", IF_SCDERS
WRITE(20,*) "NF_SC2",  NF_SC2
WRITE(20,*) "NF_SC3A", NF_SC3A
WRITE(20,*) "NF_Sc3B", NF_SC3B
WRITE(20,*) "IF_SC2_g", IF_SC2_G
WRITE(20,*) "IF_SC3a_g2", IF_SC3A_G2
WRITE(20,*) "IF_SC3b_g2", IF_SC3B_G2
WRITE(20,*) "IF_SC3a_g3", IF_SC3A_G3
WRITE(20,*) "IF_SC3B_g3", IF_SC3B_G3
WRITE(20,*) "NPROMA",  NPROMA
...
! Perform transform
IF (PRESENT(PSPVOR)) WRITE(20,*) "PSPVOR", SHAPE(PSPVOR)
IF (PRESENT(PSPDIV)) WRITE(20,*) "PSPDIV", SHAPE(PSPDIV)
IF (PRESENT(PSPSCALAR)) WRITE(20,*) "PSPSCALAR", SHAPE(PSPSCALAR)
IF (PRESENT(PSPSC3A)) WRITE(20,*) "PSPSC3a", SHAPE(PSPSC3A)
IF (PRESENT(PSPSC3B)) WRITE(20,*) "PSPSC3B", SHAPE(PSPSC3B)
IF (PRESENT(PSPSC2)) WRITE(20,*) "PSPSC2", SHAPE(PSPSC2)
IF (PRESENT(PGP)) WRITE(20,*) "PGP", SHAPE(PGP)
IF (PRESENT(PGPUV)) WRITE(20,*) "PGPUV", SHAPE(PGPUV)
IF (PRESENT(PGP3A)) WRITE(20,*) "PGP3A", SHAPE(PGP3A)
IF (PRESENT(PGP3B)) WRITE(20,*) "PGP3B", SHAPE(PGP3B)
IF (PRESENT(PGP2)) WRITE(20,*) "PGP2", SHAPE(PGP2)

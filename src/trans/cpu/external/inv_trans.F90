...
!     ------------------------------------------------------------------
INTEGER(KIND=JPIM) :: TOT_UVG
INTEGER(KIND=JPIM) :: TOT_SCALARG
INTEGER(KIND=JPIM) :: TOT_UVS
INTEGER(KIND=JPIM) :: TOT_SCALARS
!
...
IF(PRESENT(KVSETUV)) THEN
 WRITE(NOUT,*) "KVSETUV", SIZE(KVSETUV)
 WRITE(NOUT,*) KVSETUV
...
IF(PRESENT(KVSETSC)) THEN
  WRITE(NOUT,*) "KVSETSC", SIZE(KVSETSC)
  WRITE(NOUT,*) KVSETSC
...
IF(PRESENT(KVSETSC2)) THEN
    WRITE(NOUT,*) "KVSETSC2", SIZE(KVSETSC2)
   WRITE(NOUT,*) KVSETSC2
...
IF(PRESENT(KVSETSC3A)) THEN
    WRITE(NOUT,*) "KVSETSC3A", SIZE(KVSETSC3A)
   WRITE(NOUT,*) KVSETSC3A
...
IF(PRESENT(KVSETSC3B)) THEN
    WRITE(NOUT,*) "KVSETSC3B", SIZE(KVSETSC3B)
   WRITE(NOUT,*) KVSETSC3B
...
WRITE(NOUT,'(A11,I4,A2)') "NPROMA   | ", NPROMA,  ' |'
WRITE(NOUT,'(A11,I4,A2)') "NBLKS    | ", NGPBLKS, ' |'
WRITE(NOUT,'(A11,L4,A2)') "LDUVDER  | ", LUVDER,  ' |'
WRITE(NOUT,'(A11,L4,A2)') "LVORGP  | ", LVORGP,  ' |'
WRITE(NOUT,'(A11,L4,A2)') "LDIVGP  | ", LDIVGP,  ' |'
WRITE(NOUT,'(A11,L4,A2)') "LSCDERS | ", LSCDERS,  ' |'

 WRITE(NOUT,*) "IF_UV", IF_UV
 WRITE(NOUT,*) "IF_UV_G", IF_UV_G
 WRITE(NOUT,*) "IF_UV_PAR",  IF_UV_PAR
 WRITE(NOUT,*) "IF_SCALARS", IF_SCALARS
 WRITE(NOUT,*) "IF_SCALARS_G", IF_SCALARS_G
 WRITE(NOUT,*) "IF_SCDERS", IF_SCDERS
 WRITE(NOUT,*) "NF_SC2",  NF_SC2
 WRITE(NOUT,*) "NF_SC3A", NF_SC3A
 WRITE(NOUT,*) "NF_Sc3B", NF_SC3B
 WRITE(NOUT,*) "IF_SC2_g", IF_SC2_G
 WRITE(NOUT,*) "IF_SC3a_g2", IF_SC3A_G2
 WRITE(NOUT,*) "IF_SC3b_g2", IF_SC3B_G2
 WRITE(NOUT,*) "IF_SC3a_g3", IF_SC3A_G3
 WRITE(NOUT,*) "IF_SC3B_g3", IF_SC3B_G3
 WRITE(NOUT,*) "NPROMA",  NPROMA
...
WRITE(NOUT,*) "PSPVOR", SIZE(PSPVOR), SHAPE(PSPVOR)
TOT_UVS=TOT_UVS + SIZE(PSPVOR)
ENDIF
IF (PRESENT(PSPDIV))  THEN
 WRITE(NOUT,*) "PSPDIV",SIZE(PSPDIV), SHAPE(PSPDIV)
TOT_UVS=TOT_UVS + SIZE(PSPVOR)
ENDIF
IF (PRESENT(PSPSCALAR)) THEN
  WRITE(NOUT,*) "PSPSCALAR",SIZE(PSPSCALAR), SHAPE(PSPSCALAR)
  TOT_SCALARS=TOT_SCALARS + SIZE(PSPSCALAR)
ENDIF
IF (PRESENT(PSPSC3A))  THEN
 WRITE(NOUT,*) "PSPSC3a", SIZE(PSPSC3A), SHAPE(PSPSC3A)
  TOT_SCALARS=TOT_SCALARS + SIZE(PSPSC3A)
ENDIF
IF (PRESENT(PSPSC3B))  THEN
 WRITE(NOUT,*) "PSPSC3B", SIZE(PSPSC3B), SHAPE(PSPSC3B)
  TOT_SCALARS=TOT_SCALARS + SIZE(PSPSC3B)
ENDIF
IF (PRESENT(PSPSC2))   THEN
WRITE(NOUT,*) "PSPSC2", SIZE(PSPSC2), SHAPE(PSPSC2)
  TOT_SCALARS=TOT_SCALARS + SIZE(PSPSC2)
ENDIF
IF (PRESENT(PGP))  THEN
 WRITE(NOUT,*) "PGP", SIZE(PGP), SHAPE(PGP)
  TOT_SCALARG=TOT_SCALARG + SIZE(PGP)

ENDIF
IF (PRESENT(PGPUV)) THEN
  WRITE(NOUT,*) "PGPUV", SIZE(PGPUV), SHAPE(PGPUV)
  TOT_UVG=TOT_UVG + SIZE(PGPUV)
ENDIF
IF (PRESENT(PGP3A)) THEN
  WRITE(NOUT,*) "PGP3A", SIZE(PGP3A), SHAPE(PGP3A)
  TOT_UVG=TOT_UVG + SIZE(PGP3A)
ENDIF
IF (PRESENT(PGP3B)) THEN
  WRITE(NOUT,*) "PGP3B",SIZE(PGP3B), SHAPE(PGP3B)
  TOT_UVG=TOT_UVG + SIZE(PGP3B)
ENDIF
IF (PRESENT(PGP2))  THEN
 WRITE(NOUT,*) "PGP2", SIZE(PGP2), SHAPE(PGP2)
  TOT_UVG=TOT_UVG + SIZE(PGP2)
ENDIF
WRITE(NOUT,*) 'TOT_UVG', TOT_UVG
WRITE(NOUT,*) 'TOT_SCALARG', TOT_SCALARG
WRITE(NOUT,*) 'TOT_UVS', TOT_UVs
WRITE(NOUT,*) 'TOT_SCALARS', TOT_SCALARS


WRITE(NOUT,*) "CALL INV_TRANS_CTL BEGIN"
...
WRITE(NOUT,*) "CALL INV_TRANS_CTL END"

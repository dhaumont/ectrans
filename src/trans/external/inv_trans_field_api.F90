...
TYPE (SPECTRAL_S2D), OPTIONAL, INTENT(IN) :: YD_SPECTRAL_S2D(:)
TYPE (SPECTRAL_S3D), OPTIONAL, INTENT(IN) :: YD_SPECTRAL_S3D(:)
TYPE (SPECTRAL_S4D), OPTIONAL, INTENT(IN) :: YD_SPECTRAL_S4D(:)

TYPE (SPECTRAL_V2D), OPTIONAL, INTENT(OUT) :: YD_SPECTRAL_V2D(:)
TYPE (SPECTRAL_V3D), OPTIONAL, INTENT(OUT) :: YD_SPECTRAL_V3D(:)
TYPE (SPECTRAL_V4D), OPTIONAL, INTENT(OUT) :: YD_SPECTRAL_V4D(:)

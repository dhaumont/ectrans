...
!
SUBROUTINE DIR_TRANS_FIELD_API( YD_FIELDS_PGP_2D,YD_FIELDS_PGP_3D,YD_FIELDS_PGP_4D,&
                               &YD_FIELDS_PSP_2D,YD_FIELDS_PSP_3D,YD_FIELDS_PSP_4D,&
                               &KVSETSC, LDVORGP,  LDDIVGP, &
...
TYPE (FIELDS_PGP_2D), OPTIONAL, INTENT(IN) :: YD_FIELDS_PGP_2D
TYPE (FIELDS_PGP_3D), OPTIONAL, INTENT(IN) :: YD_FIELDS_PGP_3D
TYPE (FIELDS_PGP_4D), OPTIONAL, INTENT(IN) :: YD_FIELDS_PGP_4D
TYPE (FIELDS_PSP_2D), OPTIONAL,  INTENT(OUT) :: YD_FIELDS_PSP_2D
TYPE (FIELDS_PSP_2D), OPTIONAL, INTENT(OUT) :: YD_FIELDS_PSP_3D
TYPE (FIELDS_PSP_2D), OPTIONAL, INTENT(OUT) :: YD_FIELDS_PSP_4D

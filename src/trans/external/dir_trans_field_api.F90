...
!
SUBROUTINE DIR_TRANS_FIELD_API(PSPVOR,    PSPDIV,   PSPSCALAR, PSPSC3A,   &
                              &PSPSC3B,   PSPSC2,   LDLATLON,  KPROMA,    &
                              &KVSETUV,   KVSETSC,  KRESOL,    KVSETSC3A, &
                              &KVSETSC3B, KVSETSC2, PGP,       PGPUV,     &
                              &PGP3A,     PGP3B,    PGP2)                 

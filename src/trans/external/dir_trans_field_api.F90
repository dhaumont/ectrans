...
TYPE (FIELDS_PGP_2D), INTENT(IN) :: YD_FIELDS_PGP_2D
TYPE (FIELDS_PGP_3D), INTENT(IN) :: YD_FIELDS_PGP_3D
TYPE (FIELDS_PGP_4D), INTENT(IN) :: YD_FIELDS_PGP_4D
TYPE (FIELDS_PSP_2D), INTENT(OUT) :: YD_FIELDS_PSP_2D
TYPE (FIELDS_PSP_2D), INTENT(OUT) :: YD_FIELDS_PSP_3D
TYPE (FIELDS_PSP_2D), INTENT(OUT) :: YD_FIELDS_PSP_4D

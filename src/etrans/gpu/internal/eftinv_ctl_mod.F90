...
REAL(KIND=JPHOOK) :: ZHOOK_HANDLE, ZHOOK_HANDLE_BAR
...
!THOMAS
IF (LHOOK) CALL DR_HOOK('EFTINV_CTL_MOD_BAR',0,ZHOOK_HANDLE_BAR)
...
!THOMAS
IF (LHOOK) CALL DR_HOOK('EFTINV_CTL_MOD_BAR',1,ZHOOK_HANDLE_BAR)
